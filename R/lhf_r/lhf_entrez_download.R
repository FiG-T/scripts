...
install.packages("rentrez", lib = "~/scripts/lib_packages") 
library(rentrez, lib.loc = "~/scripts/lib_packages")
...
for( seq_start in seq(10,100,50)){
  ...
  cat(recs, file="mito_gb_test.txt", append=TRUE)
